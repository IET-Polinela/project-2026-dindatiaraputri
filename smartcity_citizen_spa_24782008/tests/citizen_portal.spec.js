...
// ---------------------------------------------------------------------------
const TEST_CITIZEN_USERNAME = 'tiara';
const TEST_CITIZEN_PASSWORD = 'dindacantik';
const TEST_ADMIN_USERNAME  = 'dindatia';
const TEST_ADMIN_PASSWORD  = 'dindacantik';
...
test.describe('Modul 5: Interaktivitas UI (UI-01 through UI-06)', () => {
    ...
    test('UI-02: Live Search pada daftar laporan admin berfungsi', async ({ page }) => {
        ...
        const tableBody   = page.locator('#reportTable');
